...
① _'https://lab.gomsang.com' 이하 'GomsangLab'_ 은(는) 다음의 개인정보 항목을 처리하고 있습니다.
...
### **6 . 개인정보의 파기**
_'GomsangLab'_ 은(는) 원칙적으로 개인정보 처리목적이 달성된 경우에는 지체없이 해당 개인정보를 파기합니다. 파기의 절차, 기한 및 방법은 다음과 같습니다.
...
① GomsangLab 은 개별적인 맞춤서비스를 제공하기 위해 이용정보를 저장하고 수시로 불러오는 ‘쿠기(cookie)’를 사용합니다.
